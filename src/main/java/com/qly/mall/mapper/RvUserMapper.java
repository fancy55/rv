...
public interface RvUserMapper {
    @Insert("insert into rv_user_info(user_id,rv_id_card,real_name,create_time,update_time,version,status,offset) values(#{userId},#{rvIdCard},#{realName},now(),now(),0,1,0)")
